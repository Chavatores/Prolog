...
adivina:- consult('bda.pl'),
	  nl,nl,
	  write('----------------------------------------------------------------'),nl,
	  write('BIENVENIDO AL JUEGO DONDE ADIVINARÉ EL ANIMAL QUE ESTAS PENSANDO'),nl,	  
	  write('----------------------------------------------------------------'),nl,nl,
	  pregunta.
...
no_cumple:- nl,write('>> No conozco el animal...<<'), nl,
	    write('Por favor, dime cual es la característica: '),nl,
            write('----------------------------------------------------------------'),nl,
	    read(C),
            write('----------------------------------------------------------------'),nl,
...
preguntasalir:- nl,write('----------------------------------------------------------------'),nl,
	        ...
	        write('----------------------------------------------------------------'),nl,
	        read(Respuesta),
		((Respuesta == s) -> pregunta ; write('>>>>>> Fué un gusto jugar contigo <<<<<<<'), guardar).
